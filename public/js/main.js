var player;
        ...
        function loadTour()
        {
            ...
            settings.set(TDV.PlayerSettings.SCRIPT_URL, 'script.js?v=1675754474808');
            settings.set(TDV.PlayerSettings.WEBVR_POLYFILL_URL, 'lib/WebVRPolyfill.js?v=1675754474808');
            settings.set(TDV.PlayerSettings.HLS_URL, 'lib/Hls.js?v=1675754474808');
            settings.set(TDV.PlayerSettings.QUERY_STRING_PARAMETERS, 'v=1675754474808');
